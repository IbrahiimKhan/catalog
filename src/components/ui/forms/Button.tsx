...
import VectorIcon, { VectorIconProps } from '../media-icons/VectorIcon';
...
interface ButtonIconProps extends VectorIconProps { }

const ButtonIcon: FC<ButtonIconProps> = ({ name, color, size, ...rest }): ReactElement => {
    return (
        <Box>
